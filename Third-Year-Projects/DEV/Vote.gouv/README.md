...
<p align="center">
    <img alt="mockup" title="mockup" src="./assets/big_asset.png" width="900">
</p>
...
--------------------------------------------------------------------------------------------------------------------------------------------------
<div align="center">
    <img src="./assets/asset1.png" raw=true style="margin: 10px;"/>
    <img src="./assets/asset2.png" raw=true style="margin: 10px;"/>
    <img src="./assets/asset3.png" raw=true style="margin: 10px;"/>
    <img src="./assets/asset4.png" raw=true style="margin: 10px;"/>
    <img src="./assets/asset5.png" raw=true style="margin: 10px;"/>
</div>
